...
def attention(inputs, attention_size, time_major=False, return_alphas=False):
    ...
    #sequence_size = shape[-1]  # T value - sequence lenght of the RNN layer

    # Trainable parameters
    u_omega = tf.Variable(tf.random_normal([attention_size, None], stddev=0.1), validate_shape=False)

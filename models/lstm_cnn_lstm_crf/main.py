...
def model_fn(features, labels, mode, params):
    ...
    #char_embeddings_lstm = tf.reshape(attention_output, [-1, dim_words, params['char_lstm_size']*2])# [b,tw,D]
    ...
    char_embeddings_cnn = masked_conv1d_and_max(
        char_embeddings_lstm, weights, params['filters'], params['kernel_size'])
    ...
    embeddings = tf.concat([word_embeddings, char_embeddings_cnn], axis=-1)#concat on the last dimension axis 100+300
